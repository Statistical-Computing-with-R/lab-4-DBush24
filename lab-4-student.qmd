...
In the "counties" dataset lists the counties FIP code, name and state that it is located in. There are 3,144 counties in the dataset. The "childcare_costs" dataset also contains the counties FIP code and also ..... There are 61 columns and 34,567 entries.
